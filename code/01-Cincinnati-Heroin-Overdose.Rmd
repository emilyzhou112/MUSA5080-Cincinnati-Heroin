...
The conceptualization and methodologies of this study were drawn in part from: - Choi, et al.(2022) Spatial clustering of heroin-related overdose incidents: a case study in Cincinnati, Ohio - Srinivasan, et al. (2023) Risk factors for persistent fatal opioid-involved overdose hotspots in Massachusetts 2011-2021 - Chichester, et al.(2023) Crime and Features of the Built Environment Predicting Risk of Fatal Overdose: A Comparison of Rural and Urban Ohio Counties with Risk Terrain Modeling.
...
As part of our exploratory analysis, we first ran a poisson regression using number of This requires us to
...
plot9 <- pca.logit.cv %>%
  ...
  ggplot() +
  geom_sf(aes(fill=result), color="transparent")+
  scale_fill_manual(values = c("black","#FFC000", "#BB3754"), name = "Result") +
